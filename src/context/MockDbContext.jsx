...
const defaultData = {
  ...
  students: [
    ...
    { id: 's10', name: '전준호', number: 16, stamps: { total: 11, weekly: 4, history: {} }, presentedCount: 2 },
    { id: 's11', name: '정우영', number: 17, stamps: { total: 6, weekly: 2, history: {} }, presentedCount: 1 },
    { id: 's12', name: '조선율', number: 18, stamps: { total: 15, weekly: 3, history: {} }, presentedCount: 3 },
    { id: 's13', name: '최동건', number: 19, stamps: { total: 8, weekly: 4, history: {} }, presentedCount: 2 },
    { id: 's14', name: '최재유', number: 20, stamps: { total: 22, weekly: 8, history: {} }, presentedCount: 1 },
    { id: 's15', name: '한서현', number: 21, stamps: { total: 4, weekly: 1, history: {} }, presentedCount: 0 },
    { id: 's13', name: '홍은택', number: 22, stamps: { total: 8, weekly: 4, history: {} }, presentedCount: 2 },
    { id: 's14', name: '박수아', number: 23, stamps: { total: 22, weekly: 8, history: {} }, presentedCount: 1 },
  ],
